...
if command -v rtk &>/dev/null; then
    ...
    echo "  Claude Code CLI                   : rtk init -g"
    echo "  VS Code Copilot + GitHub Copilot CLI: cp .agents/skills/rtk-token-killer/settings-vscode.json .github/hooks/rtk_settings.json"
else
